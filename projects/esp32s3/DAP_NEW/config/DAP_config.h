...
#include "DAP_NEW/include/cmsis_compiler.h"
#include "DAP_NEW/include/gpio_op.h"
#include "hal_gpio.h"
...
#else
  GPIO.out1_w1tc.data = (1 << (PIN_SWCLK - 32));
#endif
...
{
#if (PIN_SWDIO_MOSI < 32)
  GPIO.out_w1tc = (1 << PIN_SWDIO_MOSI);
#else
  GPIO.out1_w1tc.data = (1 << (PIN_SWDIO_MOSI - 32));
#endif
