...
#include "DAP_NEW/config/DAP_config.h"
#include "DAP_NEW/include/DAP.h"
#include "DAP_NEW/include/spi_op.h"
#include "DAP_NEW/include/spi_switch.h"
...
void SWJ_Sequence (uint32_t count, const uint8_t *data) {
  ...
  // {
  //   ESP_LOGI("[ERROR] wrong SWJ Swquence length:%d\r\n", (int)count);
  //   return;
  // }
...
static uint8_t SWD_Transfer_SPI (uint32_t request, uint32_t *data) {
  ...
  switch (requestByte)
    ...
    case 0xA5U:
      ...
      break;
    case 0xA9U:
      ESP_LOGI("W CTRL/STAT\r\n");
      break;
    case 0xBDU:
      ESP_LOGI("RDBUFF\r\n");
      break;
    case 0x8DU:
      ESP_LOGI("R CTRL/STAT\r\n");
      break;
    case 0x81U:
      ESP_LOGI("W ABORT\r\n");
      break;
